package com.example.log.trace.hellotrace;
...
public class HelloTraceV2 {
    ...
    public TraceStatus begin(String message){
        ...
        log.info("[{}] {}{}", traceId.getId(), addSpace(STRAT_PREFIX, traceId.getLevel()), message);
    ...
    public TraceStatus beginSync(TraceId beforeTraceId, String message){
        ...
        Long startTimeMs = System.currentTimeMillis();
        log.info("[{}] {}{}", nextId.getId(), addSpace(STRAT_PREFIX, nextId.getLevel()), message);
